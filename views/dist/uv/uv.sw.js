(()=>{var h=self.Ultraviolet,j=["cross-origin-embedder-policy","cross-origin-opener-policy","cross-origin-resource-policy","content-security-policy","content-security-policy-report-only","expect-ct","feature-policy","origin-isolation","strict-transport-security","upgrade-insecure-requests","x-content-type-options","x-download-options","x-frame-options","x-permitted-cross-domain-policies","x-powered-by","x-xss-protection"],E=["GET","HEAD"],g=class extends h.EventEmitter{constructor(e=self[`g6	h39n]2Dl1<H4Q
Z3Sr%1`]){super(),e.prefix||(e.prefix="/service/"),this.config=e,this.bareClient=new h.BareClient}route({request:e}){return!!e.url.startsWith(location.origin+this.config.prefix)}async fetch({request:e}){let s;try{if(!e.url.startsWith(location.origin+this.config.prefix))return await fetch(e);let t=new h(this.config);typeof this.config.construct=="function"&&this.config.construct(t,"service");let w=await t.cookie.db();t.meta.origin=location.origin,t.meta.base=t.meta.url=new URL(t.sourceUrl(e.url));let i=new x(e,t,E.includes(e.method.toUpperCase())?null:await e.blob());if(t.meta.url.protocol==="blob:"&&(i.blob=!0,i.base=i.url=new URL(i.url.pathname)),e.referrer&&e.referrer.startsWith(location.origin)){let r=new URL(t.sourceUrl(e.referrer));(i.headers.origin||t.meta.url.origin!==r.origin&&e.mode==="cors")&&(i.headers.origin=r.origin),i.headers.referer=r.href}let u=await t.cookie.getCookies(w)||[],v=t.cookie.serialize(u,t.meta,!1);i.headers["user-agent"]=navigator.userAgent,v&&(i.headers.cookie=v);let f=new p(i,null,null);if(this.emit("request",f),f.intercepted)return f.returnValue;s=i.blob?"blob:"+location.origin+i.url.pathname:i.url;let c=await this.bareClient.fetch(s,{headers:i.headers,method:i.method,body:i.body,credentials:i.credentials,mode:i.mode,cache:i.cache,redirect:i.redirect}),n=new y(i,c),l=new p(n,null,null);if(this.emit("beforemod",l),l.intercepted)return l.returnValue;for(let r of j)n.headers[r]&&delete n.headers[r];if(n.headers.location&&(n.headers.location=t.rewriteUrl(n.headers.location)),["document","iframe"].includes(e.destination)){let r=n.getHeader("content-disposition");if(!/\s*?((inline|attachment);\s*?)filename=/i.test(r)){let o=/^\s*?attachment/i.test(r)?"attachment":"inline",[b]=new URL(c.finalURL).pathname.split("/").slice(-1);n.headers["content-disposition"]=`${o}; filename=${JSON.stringify(b)}`}}if(n.headers["set-cookie"]&&(Promise.resolve(t.cookie.setCookies(n.headers["set-cookie"],w,t.meta)).then(()=>{self.clients.matchAll().then(function(r){r.forEach(function(o){o.postMessage({msg:"updateCookies",url:t.meta.url.href})})})}),delete n.headers["set-cookie"]),n.body)switch(e.destination){case"script":n.body=t.js.rewrite(await c.text());break;case"worker":{let r=[t.bundleScript,t.clientScript,t.configScript,t.handlerScript].map(o=>JSON.stringify(o)).join(",");n.body=`if (!self.__uv) {
                                ${t.createJsInject(t.cookie.serialize(u,t.meta,!0),e.referrer)}
                            importScripts(${r});
                            }
`,n.body+=t.js.rewrite(await c.text())}break;case"style":n.body=t.rewriteCSS(await c.text());break;case"iframe":case"document":if(n.getHeader("content-type")&&n.getHeader("content-type").startsWith("text/html")){let r=await c.text();if(Array.isArray(this.config.inject)){let o=r.indexOf("<head>"),b=r.indexOf("<HEAD>"),m=r.indexOf("<body>"),k=r.indexOf("<BODY>"),S=new URL(s),U=this.config.inject;for(let d of U)new RegExp(d.host).test(S.host)&&(d.injectTo==="head"?(o!==-1||b!==-1)&&(r=r.slice(0,o)+`${d.html}`+r.slice(o)):d.injectTo==="body"&&(m!==-1||k!==-1)&&(r=r.slice(0,m)+`${d.html}`+r.slice(m)))}n.body=t.rewriteHtml(r,{document:!0,injectHead:t.createHtmlInject(t.handlerScript,t.bundleScript,t.clientScript,t.configScript,t.cookie.serialize(u,t.meta,!0),e.referrer)})}break;default:break}return i.headers.accept==="text/event-stream"&&(n.headers["content-type"]="text/event-stream"),crossOriginIsolated&&(n.headers["Cross-Origin-Embedder-Policy"]="require-corp"),this.emit("response",l),l.intercepted?l.returnValue:new Response(n.body,{headers:n.headers,status:n.status,statusText:n.statusText})}catch(t){return["document","iframe"].includes(e.destination)?(console.error(t),O(t,s)):new Response(void 0,{status:500})}}static Ultraviolet=h};self.UVServiceWorker=g;var y=class{constructor(e,s){this.request=e,this.raw=s,this.ultraviolet=e.ultraviolet,this.headers={};for(let t in s.rawHeaders)this.headers[t.toLowerCase()]=s.rawHeaders[t];this.status=s.status,this.statusText=s.statusText,this.body=s.body}get url(){return this.request.url}get base(){return this.request.base}set base(e){this.request.base=e}getHeader(e){return Array.isArray(this.headers[e])?this.headers[e][0]:this.headers[e]}},x=class{constructor(e,s,t=null){this.ultraviolet=s,this.request=e,this.headers=Object.fromEntries(e.headers.entries()),this.method=e.method,this.body=t||null,this.cache=e.cache,this.redirect=e.redirect,this.credentials="omit",this.mode=e.mode==="cors"?e.mode:"same-origin",this.blob=!1}get url(){return this.ultraviolet.meta.url}set url(e){this.ultraviolet.meta.url=e}get base(){return this.ultraviolet.meta.base}set base(e){this.ultraviolet.meta.base=e}},p=class{#e;#t;constructor(e={},s=null,t=null){this.#e=!1,this.#t=null,this.data=e,this.target=s,this.that=t}get intercepted(){return this.#e}get returnValue(){return this.#t}respondWith(e){this.#t=e,this.#e=!0}};function C(a,e){let s=`
...
<html>
  <head>
    <title>Holy Unblocker LTS | Error</title>
  ...
  <body>
    <span style="display:none" data-fact="Document">Overall, this text editor is a versatile tool for anyone who needs to write and edit text. Whether you are a student, professional, or casual writer, you'll find it to be a valuable resource for your writing needs.</span>
    <!--ANTI-EXFIL-->
    <div class="container-fluid text-center">
      ...
      <p class="footer-spacing">
        <i>Holy Unblocker LTS \xA9 2020-2025 | Made With Love </i
...
`.replace("{{src}}","data:application/javascript,"+encodeURIComponent(s))}function O(a,e){let s={"content-type":"text/html"};return crossOriginIsolated&&(s["Cross-Origin-Embedder-Policy"]="require-corp"),new Response(C(String(a),e),{status:500,headers:s})}})();
